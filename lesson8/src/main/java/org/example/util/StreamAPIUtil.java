...
public class StreamAPIUtil {
    public static List<Specialist> getSpecialists() {
        return List.of(
                new Specialist("Ivan Ivanov", new BigDecimal(5000), Speciality.ENGINEER.ENGINEER),
                new Specialist("Alexander Alexandrov", new BigDecimal(4000), Speciality.ENGINEER.ENGINEER),
                new Specialist("Sergey Sergeev", new BigDecimal(3000), Speciality.DEVOPS),
    ...
    public static List<Specialist> filterBySpecialty(List<Specialist> specialists, Speciality specialty) {
        return specialists.stream()
                .filter(specialist -> specialist.getSpeciality().equals(specialty))
    ...
    public static Map<Speciality, List<Specialist>> groupBySpeciality(List<Specialist> specialists) {
        return specialists.stream().collect(Collectors.groupingBy(Specialist::getSpeciality));
